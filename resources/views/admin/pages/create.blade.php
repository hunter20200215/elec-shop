...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <div class="content-header-text">@lang('admin.Pages') / @lang('admin.create')</div>
        </section>
        <section class="content-container">
            <form method="POST" class="crud-form">
                <input type="hidden" name="background_image" value="{{ old('background_image') }}">
                @csrf
                <div class="form-group col-md-6" >
                    <label for="title">@lang('admin.Title')</label>
                    <input type="text" class="form-control @error('title') input-error-danger @enderror" id="title" name="title" value="{{old('title')}}" placeholder="@lang('admin.Title')">
                ...
                <div class="form-group col-md-6" >
                    ...
                    <div>
                        <img class="img-fluid" src="{{ old('background_image')
                            ? Storage::url('/temporary/pages/' . old('background_image'))
        ...
        const imagesUploadDropzone = new Dropzone("div#imageUpload", {
            ...
            init: function() {
                this.on("success", function(file, response) {
                    ...
                    document.querySelector('input[name="background_image"]').value = response.filename;
                });
            },
        });
    </script>
