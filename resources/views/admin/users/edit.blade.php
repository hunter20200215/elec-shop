        ...
        <section class="content-container">
            <form method="POST" class="crud-form">
                ...
                <div class="form-group col-md-6" >
                    ...
                    <input value="{{$user->full_name}}" type="text" class="form-control @error('full_name') input-error-danger @enderror" id="full_name" name="full_name" placeholder="@lang('admin.Full name')">
                    @error('full_name') <span style="color:red">{{$message}}</span>@enderror
                </div>
                <div class="form-group col-md-6">
                    <label for="email">@lang('admin.Email')</label>
                    <input value="{{$user->email}}" type="email" class="form-control @error('email') input-error-danger @enderror" id="email" name="email" placeholder="@lang('admin.Email')">
