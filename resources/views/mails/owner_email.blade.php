                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td class="content-cell">
                                    <h1>@lang('email.A new order has been received:')</h1>
                                    <p>@lang('email.Order ID'): {{$order->getIDWithYear()}}</p>
                                    <p>@lang('email.Customer'): {{$client->full_name}}</p>
                                    <p>@lang('email.Order Total'): {{$order->getPriceWithShipping()}}$</p>
                                    ...
                                    @endforeach
                                    <br>
                                    <p>@lang('email.Order note'): {{$order->note}}$</p>
                                </td>
                            </tr>
                        </table>
                    </td>
